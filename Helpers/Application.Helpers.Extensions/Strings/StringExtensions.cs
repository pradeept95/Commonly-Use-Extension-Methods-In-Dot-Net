...
namespace Application.Helpers.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns></returns>
        /// <created>Pradeep Raj Thapaliya,3/12/2019</created>
        /// <changed>Pradeep Raj Thapaliya,3/12/2019</changed>
        // ********************************************************************************
        public static string FirstCharToUpper(this string input)
        {
            switch (input)
            {
                ...
                case "": throw new ArgumentException("Value can not be empty");
                default: return input.First().ToString().ToUpper() + input.Substring(1);
            }
        }

        public static string ToCapitizeString(this string input)
        {
            ...
            switch (input)
            {
                case null: throw new ArgumentNullException();
                case "": throw new ArgumentException("Value can not be empty");
                default: return textInfo.ToTitleCase(input);
            }
        }
        ...
        public static string RemoveSpaces(this string input)
        {
            switch (input)
            {
                case null: throw new ArgumentNullException();
                case "": throw new ArgumentException("Value can not be empty");
                default: return input.ToString().Replace(" ", "");
            }
        }

        public static string ChangeToCamelCase(this string input)
        {
            switch (input)
            {
                case null: throw new ArgumentNullException();
                case "": throw new ArgumentException("Value can not be empty");
                default: return input.FirstCharToUpper().RemoveSpaces();
            }
        }
